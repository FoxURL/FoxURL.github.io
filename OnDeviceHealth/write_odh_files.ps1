...
Set-Content -LiteralPath .\OnDeviceHealth\index.html -Value $index -Encoding UTF8
Set-Content -LiteralPath .\OnDeviceHealth\tests\AttentionDeficitHyperactivityDisorder.html -Value $attention -Encoding UTF8
Set-Content -LiteralPath .\OnDeviceHealth\tests\AutismSpectrumDisorder.html -Value $autism -Encoding UTF8
